    ...
    <div className="flex flex-col items-center">
      ...
      <section className="w-full relative py-20 lg:py-32 overflow-hidden flex flex-col items-center justify-center min-h-[80vh]">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-[20%] -right-[10%] w-[60%] h-[60%] rounded-full bg-teal-500/10 blur-[120px]" />
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10 text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300 font-medium text-sm border border-teal-100 dark:border-teal-800/50 mb-4 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
            <Link to="/events" className="w-full sm:w-auto px-8 py-4 rounded-full bg-teal-600 hover:bg-teal-700 text-white font-semibold text-lg transition-all shadow-lg shadow-teal-500/30 flex items-center justify-center gap-2 group">
              Lihat Acara
      ...
      <section className="w-full max-w-7xl mx-auto px-4 py-16 mb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="glass-card p-8 rounded-3xl hover:-translate-y-2 transition-transform duration-300">
            <div className="w-14 h-14 rounded-2xl bg-teal-100 dark:bg-teal-900/50 flex items-center justify-center text-teal-600 dark:text-teal-400 mb-6">
              <Calendar size={28} />
            </div>
            ...
            <Link to="/events" className="text-teal-600 dark:text-teal-400 font-semibold inline-flex items-center gap-1 hover:gap-2 transition-all">
