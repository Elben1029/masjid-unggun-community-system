import { Info, MapPin, Phone, Building } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="glass-card rounded-3xl p-8 flex flex-col items-center justify-center text-center">
          ...
          {settings?.org_chart_url ? (
            <img src={settings.org_chart_url} alt="Carta Organisasi" className="rounded-xl shadow-md max-w-full" />
          ) : (
